...
class StkPage(http.Controller):
    ...
    def volunteer_webform(self, **kw):
        ...
        return http.request.render('contacts_stk.create_volunteer',  {'member_rec': member_rec}) # {'education_rec': education_rec, 'member_rec': member_rec})  # ModuleName.TemplateId
